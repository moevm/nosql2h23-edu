...
<br> Пользователи становятся доступны после прохождения миграций БД (php artisan migrate). Этап с миграциями включен в сборку приложения через docker-compose.
<br>
